  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-w-[95vw] sm:max-w-[90vw] md:max-w-lg lg:max-w-xl xl:max-w-2xl",
        // Responsive height and scrolling
        "max-h-[95vh] sm:max-h-[90vh]",
        // Styling
        "gap-4 border bg-background shadow-lg duration-200 sm:rounded-lg",
        // Focus management
    ...
    >
      ...
      <div className="overflow-y-auto p-6 max-h-[calc(95vh-4rem)] sm:max-h-[calc(90vh-4rem)]">
        {children}
      </div>
...
// Special variant for large dialogs with complex content (tables, forms with many fields)
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Large responsive width and max-width
