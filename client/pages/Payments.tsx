    ...
    <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      {formData.customerId &&
                        getAvailableInvoices(formData.customerId).map(
                          (invoice) => (
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Invoices with pending payments</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
            {Object.entries(methodBreakdown).map(([method, amount]) => (
              ...
              >
                <div
                  className={`h-8 w-8 rounded-md ${getMethodColor(method)} flex items-center justify-center`}
                >
                  ...
                  return (
                    <TableRow key={payment.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center space-x-2">
                          <div
                            className={`h-6 w-6 rounded ${getMethodColor(payment.method)} flex items-center justify-center`}
                          >
                            {React.cloneElement(getMethodIcon(payment.method), {
