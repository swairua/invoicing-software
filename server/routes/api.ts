  ...
  try {
    ...
    if (!hasData) {
      ...
      metrics = {
        ...
        topProducts: [
          { id: "sample-1", name: "Latex Gloves", category: "Medical Supplies", sales: 45000, quantity: 300, stock: 150, growth: 12 },
          { id: "sample-2", name: "Digital Thermometer", category: "Medical Equipment", sales: 36000, quantity: 30, stock: 45, growth: 8 },
          { id: "sample-3", name: "Surgical Masks", category: "Medical Supplies", sales: 27000, quantity: 300, stock: 8, growth: -5 },
        ],
        recentActivities: [
        ...
        lowStockItems: [
          { id: "sample-3", name: "Surgical Masks", currentStock: 8, minStock: 30, category: "Medical Supplies" },
          { id: "sample-4", name: "Hand Sanitizer", currentStock: 5, minStock: 20, category: "Medical Supplies" },
          { id: "sample-5", name: "Blood Pressure Monitor", currentStock: 2, minStock: 5, category: "Medical Equipment" },
        ],
        recentPaymentsList: [
